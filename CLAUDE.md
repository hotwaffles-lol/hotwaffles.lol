...
3. Rsyncs `fitmapped/` → `out/fitmapped/` (excludes `.claude`, `.DS_Store`)
...
Each subfolder has its own CLAUDE.md with project-specific context. Read it before making changes inside that folder.
